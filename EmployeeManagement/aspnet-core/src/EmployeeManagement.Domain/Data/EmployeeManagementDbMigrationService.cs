...
public class EmployeeManagementDbMigrationService : ITransientDependency
{
    public ILogger<EmployeeManagementDbMigrationService> Logger { get; set; }
    ...
    public EmployeeManagementDbMigrationService(
        ...
        IEnumerable<IEmployeeManagementDbSchemaMigrator> dbSchemaMigrators,
